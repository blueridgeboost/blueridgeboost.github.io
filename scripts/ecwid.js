...
export const SUBSCRIPTIONS_CATEGORY_ID = 187846124;
export const SESSIONS_CATEGORY_ID = 187846125;
export const SINGLE_CATEGORY_ID = 187847129;

export const ROBOTICS_ID = 175336104;
export const CODING_CATEGORY_ID = 175336105;
export const GAME_DEV_CATEGORY_ID = 187847606;
...
export const ON_DEMAND_CATEGORY_ID = 187847569;

export const ONE_DAY_CAMPS_CATEGORY_ID = 175336115;
...
export function isInProgress(c) {
     return c.categoryIds.includes(IN_PROGRESS_CATEGORY_ID);
}

export function isStartingSoon(c) {
     return c.categoryIds.includes(STARTING_SOON_CATEGORY_ID);
}

export function isOnDemand(c) {
     return c.categoryIds.includes(ON_DEMAND_CATEGORY_ID);
}

export function isMath(c) {
     return c.categoryIds.includes(MATH_CATEGORY_ID);
}

export function isAI(c) {
     return c.categoryIds.includes(AI_CATEGORY_ID);
}

export function isScience(c) {
     return c.categoryIds.includes(SCIENCE_CATEGORY_ID);
}

export function isGameDev(c) {
     return c.categoryIds.includes(GAME_DEV_CATEGORY_ID);
}

export function isCoding(c) {
     return c.categoryIds.includes(CODING_CATEGORY_ID);
}

export function isRobotics(c) {
     return c.categoryIds.includes(ROBOTICS_ID);
}

export function isOngoing(c) {
    return c.categoryIds.includes(SUBSCRIPTIONS_CATEGORY_ID);
}

export function isSession(c) {
    return c.categoryIds.includes(SESSIONS_CATEGORY_ID);
}

export function isSingle(c) {
    return c.categoryIds.includes(SINGLE_CATEGORY_ID);
}

export const getAllClasses= async () => {
    return await getCatalog([CLASSES_CATEGORY_ID]);
}
