...
<div class="gaming-hero">
  ...
  <p class="gaming-controller-announcement">
    🎮 <strong>New: Xbox controllers now available!</strong>
    Prefer a controller? Grab one for supported games during Gaming Fridays.
  </p>
...
<section id="details" class="gaming-details">
  ...
  <div class="gaming-controller-callout">
  <h3>🎮 Your Game. Your Controls.</h3>
    <p>
      Prefer thumbsticks to a keyboard and mouse? We’ve added
      <strong>blue PowerA wired Xbox controllers</strong> to our gaming lineup,
      giving players another way to jump into supported games.
    </p>
    <p>
      Our collection includes the <strong>PowerA Advantage</strong>, featuring
      mappable buttons, trigger locks, rumble motors, and a detachable
      10-foot USB-C cable.
    </p>
    <p class="gaming-controller-note">
      Controller support varies by game. Ask an instructor to help you get set up!
    </p>
  </div>
  <hr>
...
<section class="gaming-safety">
  ...
  <ul>
    ...
    <li>Clear drop-off and pick-up: doors open 5:30 PM; pickup by 8:30 PM.</li>
