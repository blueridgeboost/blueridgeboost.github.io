...
<div class="container"> 
    <div class="row">
        ...
        <div class="col-6 justify-middle">
        <center>
            <div class="gap"></div>
            <img src="/images/first-class.jpg"
                alt="First class" 
                class="img-fluid" 
                width="95%"><br>
                <b>First BRB Class at Court Square Office</b>, September 2022<br>
                (with our eager first students, Dorina and Maxwell!)
            <div class="gap"></div>
            <div class="gap"></div>
            <img src="/images/cleaning-door.jpg" class="img-fluid" width="95%" alt="BRB Office"></img><br>
            <b>Looks Clean to Me!</b>, September 2022<br>
            <div class="gap"></div>
            <div class="gap"></div>
            <img src="/images/fullpotential280.webp" alt="Full potential"
            width="95%">
            <div class="gap"></div>
            <div class="gap"></div>
            <img src="/images/opening-ivy.jpg" width="95%"
                alt="Opening our Ivy Road Location in Jan 2024"><br>
                            <b>Opening our Ivy Road Office</b>, January 2024
        </center>
        </div>
    </div>
</div>