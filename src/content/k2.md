...
# Block Language Coding for Lower Elementary School Students

<div class="row">

<div class="col-sm-12 left">

Students learn fundamental coding concepts by helping [a beaver build a dam](https://www.codemonkey.com/courses/beaver-achiever/) on instructor-provided Chromebooks. Students learn to code using simple commands to move left, right and drop logs. Next, students learn to code repetition using repeat loops that are executed a fixed or a variable number of times. In the second part of the course, students learn to code using conditional loops. In the third part of the course, students learn to code using conditional statements with simple and compound conditions.  

The classes run on 4 week-sessions. Each class is 45 minutes long. Classes are adjusted to the pace of the student with students typically needing between four six sessions to complete the course depending on age and previous coding experience.
...
In this session, the students learn conditional loops, loops that repeat based on a certain
condition. Students will master the use of loops, combinations between loops, nested loops and more.<br>
